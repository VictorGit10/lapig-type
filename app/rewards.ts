...
export const EFFECTS: EffectItem[] = [
  ...
  { key: 'solar-pulse', achievement: 'top_1', name: { pt: 'Pulso solar', en: 'Solar pulse', es: 'Pulso solar' }, description: { pt: 'Raios dourados reservados ao líder.', en: 'Golden rays reserved for the leader.', es: 'Rayos dorados reservados al líder.' } },
